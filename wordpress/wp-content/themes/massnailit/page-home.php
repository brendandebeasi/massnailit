...
<div class="row main">
    <div class="row">
        <div class="large-8 column">
            <ul data-orbit>
                <li><a href="/live-classroom-csl-education"><img src="<?php bloginfo('stylesheet_directory'); ?>/slides/affordableeducation-warm@2x.jpg" alt=""/></a></li>
                <li><a href="/online-contractor-csl-education"><img src="<?php bloginfo('stylesheet_directory'); ?>/slides/license-expire-hothothot@2x.jpg" alt=""/></a></li>
                <li><a href="/books"><img src="<?php bloginfo('stylesheet_directory'); ?>/slides/codebooks-dontdropme@2x.jpg" alt=""/></a></li>
                <li><a href="/massachusetts-regulations"><img src="<?php bloginfo('stylesheet_directory'); ?>/slides/bbrs-regulations-tunnel@2x.jpg" alt=""/></a></li>
